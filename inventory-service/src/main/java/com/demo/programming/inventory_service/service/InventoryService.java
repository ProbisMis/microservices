...
public class InventoryService {
    ...
    public void reserveInventory(String orderNumber, List<OrderLineItemEvent> orderLineItems) {
        ...
        for (OrderLineItemEvent lineItem : orderLineItems) {
            ...
            inventory.setReservedQuantity(
                    (inventory.getReservedQuantity() != null ? inventory.getReservedQuantity() : 0) + lineItem.getQuantity());
            ...
            log.info("Reserved {} units of {} for order {}", lineItem.getQuantity(), lineItem.getSkuCode(), orderNumber);
        }
    ...
    public void releaseReservation(String orderNumber) {
        ...
        for (InventoryReservation reservation : reservations) {
            ...
            if (inventory != null) {
                inventory.setReservedQuantity(
                        Math.max(0, (inventory.getReservedQuantity() != null ? inventory.getReservedQuantity() : 0) - reservation.getQuantity()));
                inventoryRepository.save(inventory);
                log.info("Released {} units of {} for order {}", reservation.getQuantity(), reservation.getSkuCode(), orderNumber);
            }
        }
